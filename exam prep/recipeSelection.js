...
// console.log(recipeSelection.getRecipesByCategory('string', []))
// console.log(recipeSelection.getRecipesByCategory([{title: 'Something', category: 'Bulgarian'}, {title: 'Something2', category: 'Asian'}], 'Bulgarian'))